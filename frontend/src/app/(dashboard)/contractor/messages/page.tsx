  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <p className="text-slate-500 mt-1">Chat with customers for your won projects.</p>
      </div>
      ...
      {chats.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 bg-white rounded-2xl border border-slate-200">
          ...
          <p className="text-slate-400 text-sm mt-1 max-w-sm text-center">
            When a customer accepts your bid, a chat room will automatically appear here.
          </p>
        </div>
      ) : (
